    ...
    >
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--border)] bg-[var(--bg-card)]">
        <div className="flex items-center gap-[10px]">
          ...
          <span className="px-[10px] py-[3px] bg-[var(--bg-black)] text-[var(--text-inverse)] rounded-[var(--radius-pill)] text-[10px] font-semibold">
            FR
          </span>
        </div>
      ...
      <div className="grid grid-cols-[1fr_180px] h-[200px]">
        ...
        <div className="p-4 bg-[var(--bg-warm)] border-l border-[var(--border)] overflow-hidden">
          <div className="text-[9px] font-semibold uppercase text-[var(--text-muted)] mb-2 flex items-center gap-[5px]">
