  ...
  return (
    <div className="px-10 py-10 max-w-[1100px]">
      ...
      <section className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-3 mb-10">
        ...
        >
          <div>
            <div className="text-[11px] font-semibold uppercase text-[var(--text-inverse-muted)] mb-[2px]">
              Nouvelle analyse
            </div>
        ...
        >
          <div>
            <div className="text-[11px] font-semibold uppercase text-[var(--text-muted)] mb-[2px]">
              Dossier client
            </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-[13px] truncate flex items-center gap-2">
                    {f.name}
                    {f.scope === "agency" && (
                      <span className="text-[9px] uppercase px-[5px] py-[1px] rounded-[var(--radius-pill)] bg-[var(--bg-olive-light)] text-[var(--text)]">
                        agence
                      </span>
                    )}
                  </div>
...
function ShareDonut({ share, myBriefs, totalBriefs }: { share: number; myBriefs: number; totalBriefs: number }) {
  ...
  return (
    <div className="bg-[var(--bg-black)] text-[var(--text-inverse)] rounded-[var(--radius)] p-7 flex flex-col">
      <div className="text-[10px] font-semibold uppercase text-[var(--text-inverse-muted)] mb-1">
        Votre part ce mois
      </div>
...
function Stat({ label, value, accent }: { label: string; value: string; accent?: boolean }) {
  return (
    <div className="flex items-baseline justify-between gap-2 pb-2 border-b border-[rgba(255,255,255,0.16)] last:border-0 last:pb-0">
      <span className="text-[11px] uppercase font-semibold opacity-45">{label}</span>
      <span
...
function Leaderboard({
  ...
  return (
    <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-[var(--radius)] p-6">
      <div className="text-[10px] font-semibold uppercase text-[var(--text-muted)] mb-4">
