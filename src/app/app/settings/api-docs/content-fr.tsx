...
/**
 * Documentation d'API, version française.
 *
 * La doc est une longue prose technique : la traduire clé par clé la rendrait
 * illisible côté dictionnaire. On garde donc une version par langue, et
 * `page.tsx` choisit celle qui correspond à la locale. Les deux fichiers
 * partagent les mêmes primitives de mise en page (`./ui`).
 */
export function ApiDocsFr() {
  return (
    <>
