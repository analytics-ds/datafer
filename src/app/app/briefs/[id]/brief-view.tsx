    ...
    <div className="px-10 py-10 max-w-[1200px]">
      ...
      <header className="mb-10">
        <div className="flex items-center gap-2 mb-3 flex-wrap">
          ...
          {nlp?.intent && (
            <span
              className="px-[10px] py-[3px] rounded-[var(--radius-pill)] text-[10px] font-semibold uppercase"
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {nlp.semanticClusters.map((c) => (
              ...
              >
                <div className="text-[11px] font-semibold uppercase text-[var(--text-muted)] mb-2">
                  {c.label}
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-[11px] font-semibold uppercase text-[var(--text-muted)] mb-4 flex items-center gap-2">
