  ...
  return (
    <div className="relative shrink-0" ref={ref}>
      <button
        ...
        className="flex items-center justify-center w-[18px] h-[18px] rounded-[var(--radius-xs)] text-[var(--text-muted)] hover:bg-[var(--bg)] hover:text-[var(--text)] transition-colors cursor-pointer"
