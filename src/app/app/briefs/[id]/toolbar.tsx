      ...
      >
        ...
        {tab === "url" && (
          <div className="space-y-3">
            <div>
              <label className="text-[11px] font-semibold uppercase text-[var(--text-muted)] mb-[5px] block">
                URL de l&apos;image
              </label>
              <input
                type="url"
        ...
        {preview && (
          <div className="mt-4">
            <div className="text-[10px] font-semibold uppercase text-[var(--text-muted)] mb-[5px]">
              Aperçu
            </div>
